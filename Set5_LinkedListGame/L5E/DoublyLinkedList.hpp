...
class DoublyLinkedList {
    ...
    void listMergeSort();                       //Merge sort of a list object, also uses another merge sort with pointers
...
template <typename T>
void DoublyLinkedList<T>::listMergeSort() {         //Merge sort a linked list
